...
namespace ShelfWise.Repository.Data
{
    public static class DbInitializer
    {
        ...
        private static void SeedDemoUsers(AppDbContext context)
        {
            EnsureUser(context, "patron@shelfwise.dev", "Patron", "Demo", "Patron");
            EnsureUser(context, "librarian@shelfwise.dev", "Librarian", "Demo", "Librarian");
            EnsureUser(context, "admin@shelfwise.dev", "Admin", "Demo", "Admin");
        }

        private static void EnsureUser(AppDbContext context, string username, string role, string firstName, string lastName)
        {
        ...
        private static void EnsureSchema(AppDbContext context)
        {
            ...
            context.Database.ExecuteSqlRaw("""
                ...
                ALTER TABLE "Users" ADD COLUMN IF NOT EXISTS "Role" text NOT NULL DEFAULT 'Patron';
